...
VECTOR_DB_TYPE=qdrant /home/daniel/sigphi/venv/bin/python3 scripts/remove_files.py "${FILES[@]}"
...
echo "=== APLICANT ==="
VECTOR_DB_TYPE=qdrant /home/daniel/sigphi/venv/bin/python3 scripts/remove_files.py --apply "${FILES[@]}"
echo "Fet."
